 ...
 * 需求：在开发模式下，使用本地的第三方库，在生产模式下使用CDN地址
 * 17.1 在html中引入第三方库的CDN地址，并用模板语法判断模式
 * 17.2 配置 webpack.config.js 中 externals 外部拓展选项（防止某些import的包被打包）
 * 17.3 打包后观察效果
*/
 ...
 * 目标18：多页面打包
 * 
 * 18.1 准备源码（html，js，css）放入相应的位置，并改用模块化语法导出
 * 18.2 下载 form-serialize 包，并导入到核心代码中使用（暂时略过）
 * 18.3 配置 webpack.config.js 中 多入口和多出口设置
 * 18.4 打包后观察效果
*/